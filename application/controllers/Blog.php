...
class Blog extends CI_Controller
{
	...
	function detail($slug)
	{
		...
		$x['views'] = $this->m_tulisan->count_views($kode);
		$x['love'] = $this->m_tulisan->count_love($kode);
		$x['good'] = $this->m_tulisan->count_good($kode);
		$x['like'] = $this->m_tulisan->count_like($kode);
